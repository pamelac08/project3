...
const benchmarkSeed = [
  ...
  },
  {
    name: "Baseline",
    type: "For Time",
    workout: ["500m Row", "40 Air Squats", "30 Sit-ups", "20 push-ups", "10 Pull-ups"]
  },
  {
    name: "Fight Gone Bad",
    type: "3 Rounds for Time - One minute each move, max reps",
    workout: ["Wall Balls 20/14lb 10/8ft target", "Sumo Deadlift High Pull 75/55lbs", "Box Jumps 20' box", "Push-Press 75/55 lb", "Row (calories)", "Rest"]
  },
  {
    name: "The Ghost",
    type: "6 rounds",
    workout: ["1 min Rowing", "1 min Burpess", "1 min double-unders", "1 min Rest"]
  },
  {
    name: "Christine",
    type: "3 Rounds for Time",
    workout: ["500m Row", "12 deadlifts (bodyweight)", "21 Box Jumps (24/20 box)"]
  },
  {
    name: "Fran",
